<template>
    <div class="flex flex-col w-64 h-screen px-4 py-8 bg-white border-r dark:bg-slate-900 ">
        <img src="../assets/icon.png" alt="ExpressCoin" class="absolute w-11 top-7">
        <h2 class="text-3xl font-semibold text-indigo-700 dark:text-indigo-700 ml-10">Express<span class="text-indigo-400">Coin</span></h2>
